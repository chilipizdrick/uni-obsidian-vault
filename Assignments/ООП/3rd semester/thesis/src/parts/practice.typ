...
#figure(
  image("../images/lrs-result.png"),
  caption: [Демонстрация работы алгоритма поиска длиннейшей повторяющейся подстроки с применением структуры суффиксного дерева в свой реализации.],
) <image-lrs-result>
