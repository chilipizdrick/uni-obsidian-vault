...
= \left( \sum_{n=0}^{\infty} (-1)^{n}x^{n+2} \right)'' = \left( x^{2}\underbrace{\sum_{n=0}^{\infty} (-1)^{n}x^{n}}_{\frac{1}{1+x}} \right)'' = \left( \frac{x^{2}}{1+x} \right)'' = \\
= \left( \frac{2x(1+x^{2}) - x^{2}}{(1+x)^{2}} \right)' = \frac{2}{(1+x)^{3}}
\end{gather}$$

### 14

$$\begin{gather}
S(x) = \sum_{n=0}^{\infty} \frac{(x-3)^{n+1-1}}{n+1} = \frac{1}{x-3}\sum_{n=0}^{\infty} \frac{(x-3)^{n+1}}{n+1} = \\
= \frac{1}{x-3}\left( \int_{0}^{n} (x-3)^{t} \, dt  \right) 
\end{gather}$$