...
$$\begin{gather}
e^{iw} = \sqrt{ \frac{i-z}{i+z} } \\
iw = \frac{1}{2}\mathrm{Ln} \ \frac{i-z}{i+z} \\
w = -\frac{i}{2}\mathrm{Ln} \ \frac{i-z}{i+z}
\end{gather}$$

$$\begin{gather}
z_{0} = \frac{i}{3} \\
w = -\frac{i}{2}\mathrm{Ln} \frac{\frac{2i}{3}}{\frac{4i}{3}} = -\frac{i}{2} \mathrm{Ln} \ \frac{1}{2} = \frac{i}{2}\ln 2
\end{gather}$$