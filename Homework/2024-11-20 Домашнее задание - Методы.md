...
= \sum_{n=0}^{\infty} \frac{\frac{1}{2}\cdot \left( -\frac{1}{2} \right)\cdot \left( -\frac{3}{2} \right)\dots\left( -\frac{2n-3}{2} \right)}{n!}u^{n} = \sum_{n=0}^{\infty} \frac{(-1)^{n}(2n-3)!!}{2^{n+1}n!}u^{n} = \\
