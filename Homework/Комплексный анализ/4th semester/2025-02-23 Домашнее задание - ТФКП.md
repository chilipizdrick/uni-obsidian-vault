...
-i\mathrm{Ln} \ \left( \frac{i (3\sqrt{ 2 } + \sqrt{ 14 })}{2} \right) \\
-i\mathrm{Ln} \ \left( \frac{i (3\sqrt{ 2 } - \sqrt{ 14 })}{2} \right) 
\end{cases} \\
z-\frac{\pi}{4} = -i\mathrm{Ln} \ \left( \frac{i(3\pm \sqrt{ 7 })}{\sqrt{ 2 }} \right) \\
\end{gather}$$

$$\begin{gather}
z-\frac{\pi}{4} = -i\left( \ln \frac{3\pm \sqrt{ 7 }}{\sqrt{ 2 } } + \frac{i\pi}{2} + 2\pi k \right) \\
z = 2\pi k + \frac{3\pi}{4} - i \ln \frac{3\pm \sqrt{ 7 }}{\sqrt{ 2 }}
\end{gather}$$
