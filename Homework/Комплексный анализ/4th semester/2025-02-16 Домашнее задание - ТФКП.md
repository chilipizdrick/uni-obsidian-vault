...
= 1024\cdot \frac{(e^{i\pi/3})^{20}}{(e^{-i\pi/4})^{20}} = 1024\cdot \frac{e^{i\cdot 2\pi/3}}{e^{i\cdot(-\pi)}} = 1024e^{i(2\pi/3 + \pi)} = 1024 e^{-i\pi/3} = \\
= 1024\left( \frac{1}{2} - \frac{\sqrt{ 3 }}{2}i \right) = 512 - 512\sqrt{ 3 }i
\end{gather}$$
