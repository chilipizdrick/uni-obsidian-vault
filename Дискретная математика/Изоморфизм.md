...
$$
$$
(x_{1}, x_{2}) \in \mathbb{Z}_{5} \times \mathbb{Z}_{43} \sim (x_{1} \cdot 130 + x_{2} \cdot 86) \ mod \ 215 \in \mathbb{Z}_{215}
$$
Пример для $x=135$:
$$
135 \ mod \ 215 \sim (135 \ mod \ 5, 135 \ mod \ 43) = (0, 6) \in \mathbb{Z}_{5} \times \mathbb{Z}_{43}
$$
$$
(0,6) \sim (130 \cdot 0 + 86 \cdot 6) \ mod \ 215 = 
$$
