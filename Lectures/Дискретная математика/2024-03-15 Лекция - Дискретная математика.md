...
>[!ABSTRACT]
>Это многочлен от нескольких переменных, для которого декартовое произведение поля из двух элементов ставится в соответствие элемент поля из двух элементов:
