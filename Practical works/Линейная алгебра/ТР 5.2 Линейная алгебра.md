...
Тогда корневые подпространства оператора $X$ соответствующие собственному значению $\lambda_{1,2,3} = -3$ соответствующих глубин будут иметь вид:
...
Указанные в задании базисы - это базисы найденных собственных или (в случае не диагонализируемых матриц) корневых подпространств:
