...
Указанные в задании базисы - это базисы найденных собственных или (в случае недиагонализируемых матриц) корневых подпространств:
...
### $Y$:
Сопряженные комплексные собственные значения $\lambda_{2,3} = 1\pm i$ образуют матрицу умножения на комплексное число $\begin{pmatrix} 1 & 1 \\ -1 & 1\end{pmatrix}$.
