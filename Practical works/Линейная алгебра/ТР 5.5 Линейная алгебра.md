...
-(4+\lambda)(-36-4\lambda+9\lambda+\lambda^{2}+40)-(49+7\lambda-40)+(28-16+4\lambda)=0 \\
-(4+\lambda)(4+5\lambda+\lambda^{2})-(9+7\lambda)+(12+4\lambda)=0 \\
-16-20\lambda-4\lambda^{2}-4\lambda-5\lambda^{2}-\lambda^{3}-9-7\lambda+12+4\lambda=0 \\
-\lambda^{3}-9\lambda^{2}-27\lambda-13=0
\end{gather}$$
