...
$$\begin{gather}
\text{Сокр. ДНФ} = \underbrace{\overline{x_{2}}\overline{x_{3}} \vee \overline{x_{1}}x_{4}}_{\text{Ядр. ДНФ}} \vee x_{2}x_{3}x_{4} \vee x_{1}x_{3}\overline{x_{4}} \vee x_{1}x_{2}x_{3} \vee 
\end{gather}$$
