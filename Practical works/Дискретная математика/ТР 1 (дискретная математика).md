...
Найдем соответствующие образующие элемеины в $\mathbb{Z}_{11}, \mathbb{Z}_{7}, \mathbb{Z}_{5}$:

$$\begin{align}
&1) \ \mathbb{Z}_{11}: \ 2^{11} \ (mod \ 11) = 2 \implies \mathrm{ord} \ 2|_{\mathbb{Z}_{11}} = 11 \\
&1) \ \mathbb{Z}_{7}: \ 3^{7} \ (mod \ 7) = 3 \implies \mathrm{ord} \ 3|_{\mathbb{Z}_{7}} = 7 \\
&3) \ \mathbb{Z}_{5}: \ 2^{11} \ (mod \ 11) = 2 \implies \mathrm{ord} \ 2|_{\mathbb{Z}_{11}} = 11
\end{align}$$
