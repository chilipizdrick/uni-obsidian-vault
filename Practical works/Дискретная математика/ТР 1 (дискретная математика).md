...
имеем, что $\mathbb{Z}_{11}, \mathbb{Z}_{7}, \mathbb{Z}_{5}$ - циклические группы (11, 7, 5 - простые числа), следовательно в них есть образующий элемент, и его порядок в данной группе - максимальный и рав.
