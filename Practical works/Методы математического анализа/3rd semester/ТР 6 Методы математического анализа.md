...
= \lim_{ x \to \pi-0 } \left[\frac{\pi^{2}}{3} + \frac{1}{2} + \sum_{k=1}^{n} \left(\left( \left( \frac{4}{\pi n^{3}} - \frac{1}{\pi n} - \frac{2\pi}{n} \right)(-1)^{n} + \frac{1}{\pi n} - \frac{4}{\pi n^{3}} \right) \sin xn + \right.\right. \\
\left.\left.+\frac{(-1)^{n}4}{n^{2}}\cos nx \right)\right] = \frac{\pi^{3}}{3} + \frac{1}{2} + \frac{4}{n^{2}} \\
\end{gather}$$

То переходя в вышеупомянутом неравенстве к пределу при $x \to \pi-0$, получим

$$\begin{gather}
|2\pi^{2}+1 - \frac{\pi^{3}}{3} - \frac{1}{2} - \frac{4}{n^{2}}| \leq 0.01
\end{gather}$$
