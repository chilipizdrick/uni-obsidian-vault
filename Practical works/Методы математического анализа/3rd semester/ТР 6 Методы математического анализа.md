...
$$\begin{gather}
S(x) = \sum_{n=1}^{\infty} \left( \left( \frac{2}{\pi n^{3}} - \frac{2}{\pi n} - \frac{4\pi}{n} \right)(-1)^{n} + \frac{1}{\pi n} - \frac{8}{\pi n^{3}} \right) \sin xn
\end{gather}$$

$P_{2}(x)$:

![[Pasted image 20241212130026.png|300]]

$P_{3}(x)$:

![[Pasted image 20241212130051.png|300]]

$P_{10}(x)$:

![[Pasted image 20241212130112.png|300]]

Полученный ряд сходится неравномерно на $\mathbb{R}$.
