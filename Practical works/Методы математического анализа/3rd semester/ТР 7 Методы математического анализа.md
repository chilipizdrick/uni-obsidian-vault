...
= \frac{1}{3} \left( \int_{0}^{1} x\cdot \sin \frac{\pi kx}{2} \, dx + \int_{1}^{2} (2-x)\cdot \sin \frac{\pi kx}{2} \, dx \right) = \\ 
= 
\end{gather}$$

$$\begin{gather}
I_{1} = \left.-\frac{2x}{\pi k}\cos \frac{\pi kx}{2}\right|_{x=0}^{x=1} + \frac{2}{\pi k}\int_{0}^{1} \cos \frac{\pi kx}{2} \, dx = -\frac{2}{\pi k}\cos \frac{\pi k}{2}
\end{gather}$$