...
В пунктах а) и б) получились похожие, но разные функции, каждая из которых удовлетворяет данным в задаче условиям $y(0) = 0, \ y'(0) = 0$ в силу того факта что $-3\cdot \frac{1}{3} = -3\cdot -\frac{1}{48}$