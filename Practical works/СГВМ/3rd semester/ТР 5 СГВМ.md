...
= \frac{1}{3}\left.\left[ \tau \left( e^{\tau} - \frac{e^{-3x}}{4}\cdot e^{4\tau} \right)  \right]\right|_{\tau=0}^{\tau=x} - \frac{1}{3}\int_{0}^{x} \left( e^{\tau} - e^{-3x}\cdot e^{4\tau} \right)  \, d\tau = \\
\end{gather}$$

$$\begin{gather}
= \frac{1}{3}\left.\left[ \tau \left( e^{\tau} - \frac{e^{-3x}}{4}\cdot e^{4\tau} \right) - e^{\tau} + \frac{e^{-3x}}{4}\cdot e^{4\tau} \right]\right|_{\tau=0}^{\tau=x} = \\
= \frac{1}{3} \left[ x\left( e^{x} - \frac{e^{x}}{4} \right) - e^{x} + \frac{e^{x}}{4} + 1 - \frac{e^{-3x}}{4} \right] = \\
= \frac{1}{4}xe^{x} - \frac{1}{4}e^{x} - \frac{1}{12}e^{-3x} + \frac{1}{3}
\end{gather}$$
